...
{
    public function testEqualToTheMinuteWithSameTimes(): void
    {
    ...
    public function testEqualToTheMinuteWithDifferentMinutes(): void
    {
        $time1 = Carbon::parse('2025-01-19 12:30:15');
    ...
    public function testEqualToTheMinuteWithDifferentHours(): void
    {
        $time1 = Carbon::parse('2025-01-19 12:30:15');
    ...
    public function testEqualToTheMinuteWithCarbonAndDatetimeInterface(): void
    {
    ...
    public function testEqualToTheMinuteWithStringDates(): void
    {
    ...
    public function testEqualToTheMinuteWithNullValues(): void
    {
    ...
    public function testEqualToTheMinuteIgnoresSecondsAndMicroseconds(): void
    {
    ...
    public function testToCarbonWithCarbonInstance(): void
    {
    ...
    public function testToCarbonWithDatetimeInterface(): void
    {
    ...
    public function testToCarbonWithString(): void
    {
    ...
    public function testToCarbonWithNull(): void
    {
    ...
    public function testToCarbonWithTimezoneAndCarbonInstance(): void
    {
        $timezone = new DateTimeZone('America/New_York');
    ...
    public function testToCarbonWithDifferentTimezones(): void
    {
    ...
    public function testEqualToTheMinutePreservesOriginalInstances(): void
    {
        $time1 = Carbon::parse('2025-01-19 12:30:15.123456');
    ...
    public function testEqualToTheMinuteWithMixedTypes(): void
    {
        $carbon = Carbon::parse('2025-01-19 12:30:15');
        $datetime = new DateTimeImmutable('2025-01-19 12:30:45');
    ...
    public function testToCarbonEdgeCases(): void
    {
