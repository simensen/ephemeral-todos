...
{
    public function test_default_completion_awareness_applies_to_all()
    {
    ...
    public function test_and_is_complete_configuration()
    {
    ...
    public function test_and_is_incomplete_configuration()
    {
    ...
    public function test_whether_completed_or_not_configuration()
    {
    ...
    public function test_chaining_completion_aware_methods()
    {
    ...
    public function test_immutability_of_completion_aware_methods()
    {
    ...
    public function test_applies_always_logic()
    {
