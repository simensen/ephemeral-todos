...
class NullValueErrorConditionTest extends TestCase
{
    ...
    public function testUtilsToCarbonWithNull()
    {
    ...
    public function testUtilsEqualToMinuteWithNullCombinations()
    {
    ...
    public function testDefinitionFinalizeWithoutRequiredFields()
    {
    ...
    public function testTodosReadyToBeCreatedAtWithNull()
    {
        $todos = new Todos();
    ...
    public function testTodosNextInstancesWithNull()
    {
        $todos = new Todos();
    ...
    public function testTodoConstructorWithNullValues()
    {
    ...
    public function testTodoConstructorWithAllNullDeletionTimes()
    {
        $createAt = Carbon::parse('2024-01-15 10:00:00')->toDateTimeImmutable();
    ...
    public function testTodoConstructorWithPartialDeletionTimes()
    {
        $createAt = Carbon::parse('2024-01-15 10:00:00')->toDateTimeImmutable();
    ...
    public function testScheduleWithEmptyCronExpression()
    {
    ...
    public function testDefinitionWithNullPriority()
    {
    ...
    public function testDefinitionWithNullDescription()
    {
        $definition = Definition::define()
    ...
    public function testEmptyTodosCollection()
    {
        $todos = new Todos();
    ...
    public function testDefinitionWithoutName()
    {
    ...
    public function testInvalidTimeStringsHandling()
    {
    ...
    public function testDefinitionFinalizeWithOnlyCreate()
    {
    ...
    public function testDefinitionFinalizeWithOnlyDue()
    {
    ...
    public function testZeroPriorityHandling()
    {
    ...
    public function testExtremeDeletionTimeCombinations()
    {
        $createAt = Carbon::parse('2024-01-15 10:00:00')->toDateTimeImmutable();
    ...
    public function testContentHashWithNullValues()
    {
        $createAt = Carbon::parse('2024-01-15 10:00:00')->toDateTimeImmutable();
    ...
    public function testTodosDefineWithNullCallableResult()
    {
        $todos = new Todos();
    ...
    public function testScheduleIsDueWithNullTime()
    {
    ...
    public function testEmptyStringNameHandling()
    {
    ...
    public function testEdgeCaseTimezoneWithNull()
    {
