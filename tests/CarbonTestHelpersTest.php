...
class CarbonTestHelpersTest extends TestCase
{
    ...
    public function test_carbon_test_now_functionality()
    {
    ...
    public function test_time_travel_for_schedule_testing()
    {
        $todos = new Todos();
    ...
    public function test_multi_day_schedule_progression()
    {
        $todos = new Todos();
    ...
    public function test_deletion_timing_with_time_manipulation()
    {
        $todos = new Todos();
    ...
    public function test_before_due_creation_timing()
    {
        $todos = new Todos();
    ...
    public function test_rapid_time_progression()
    {
        $todos = new Todos();
    ...
    public function test_time_precision_and_rounding()
    {
        $todos = new Todos();
    ...
    public function test_time_isolation_between_tests()
    {
    ...
    public function test_time_was_reset_from_previous_test()
    {
    ...
    public function test_complex_scheduling_scenario_with_time_travel()
    {
        $todos = new Todos();
