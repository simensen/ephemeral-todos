...
class TodosTest extends TestCase
{
    ...
    public function test_can_create_empty_todos_collection()
    {
        $todos = new Todos();
    ...
    public function test_can_define_todo_using_definition_object()
    {
        $todos = new Todos();
    ...
    public function test_can_define_todo_using_finalized_definition()
    {
        $todos = new Todos();
        $definition = Definition::define()
            ->withName('Test Task')
    ...
    public function test_can_define_todo_using_callable()
    {
        $todos = new Todos();
    ...
    public function test_can_define_multiple_todos()
    {
        $todos = new Todos();
    ...
    public function test_ready_to_be_created_at_filters_correctly()
    {
        $todos = new Todos();
    ...
    public function test_next_instances_generates_todo_objects()
    {
        $todos = new Todos();
    ...
    public function test_next_instances_with_scheduled_todos()
    {
        $todos = new Todos();
    ...
    public function test_ready_to_be_created_at_with_default_time()
    {
        $todos = new Todos();
    ...
    public function test_next_instances_with_default_time()
    {
        $todos = new Todos();
    ...
    public function test_complex_collection_scenario()
    {
        $todos = new Todos();
