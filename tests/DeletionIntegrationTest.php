...
class DeletionIntegrationTest extends TestCase
{
    ...
    public function testTodoWithAfterDueByDeletionRule()
    {
    ...
    public function testTodoWithAfterExistingForDeletionRule()
    {
        $definition = Definition::define()
    ...
    public function testCompletionAwareDeletionScenarios()
    {
        $definition = Definition::define()
    ...
    public function testComplexDeletionScenarioWithScheduling()
    {
        $definition = Definition::define()
    ...
    public function testDifferentDeletionStrategiesComparison()
    {
    ...
    public function testDeletionRuleWithDifferentTimeDurations()
    {
        $testCases = [
    ...
    public function testNoDeletionRuleResultsInNull()
    {
        $definition = Definition::define()
